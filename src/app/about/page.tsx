...
function SectionLabel({ icon: Icon, children }: { icon: typeof MapPin; children: string }) {
  return (
    ...
    <main className="mx-auto flex min-h-screen-safe w-full max-w-[480px] flex-col gap-8 px-4 py-10">
      ...
      <section aria-labelledby="hours-heading" className="flex flex-col gap-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-fg-secondary" id="hours-heading">
            <Clock className="size-5 shrink-0" aria-hidden="true" strokeWidth={1.75} />
            <span className="text-headline text-foreground">Hours</span>
          </div>
          <OpenStatusBadge />
        </div>
